...
(function (root, factory) {
	...
	module.exports = factory(require('object.assign'));
        ...
        root.Object = factory(root.ObjectAssign);
    }
...
function factory(ObjectAssign) {     
	...
	Object.getOwnPropertyNames(Object.prototype).forEach(function(prop) {
	    if (!polyfill.prototype.hasOwnProperty(prop)) {
		polyfill.prototype[prop] = Object.prototype[prop];
	    }
	});
	    
	Object.getOwnPropertyNames(Object).forEach(function(prop) {
	    if (!polyfill.hasOwnProperty(prop)) {

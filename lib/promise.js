...
function factory(promise_polyfill) {
	...
	var promise_native = typeof Promise === 'function' ? Promise : undefined;

	return force !== undefined || promise_native === undefined  ?  promise_polyfill.Polyfill : promise_native;
